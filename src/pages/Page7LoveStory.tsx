...
const timeline = [
  ...
  { when: 'Then...', what: 'Someone started smiling at their phone like an idiot. 😂' },
  { when: 'Now...', what: "There's a birthday girl reading this." },
]
      ...
      <div className="flex flex-1 flex-col gap-4">
        ...
        <div className="relative pl-2">
          ...
          <div className="flex flex-col gap-3">
            {timeline.map((item, i) => (
              <FadeIn key={item.what} delay={0.12 + i * 0.12} className="relative flex gap-3">
                ...
                <div className="glass-card flex-1 rounded-2xl px-4 py-3">
                  <p className="font-script text-lg text-rose leading-none mb-1">{item.when}</p>
        ...
        <GlassCard delay={0.75} className="text-center !py-4">
          <p className="text-sm leading-relaxed text-burgundy/85">
            And somewhere along the way,
            <br />
            you became a very special part of {BOY_NAME}&apos;s life.
          </p>
        </GlassCard>

        <FadeIn delay={0.9} className="mt-auto pt-1">
